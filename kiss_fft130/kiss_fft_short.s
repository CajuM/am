...
# PRED: ENTRY [100.0%]  (FALLTHRU)
	...
	movl	%eax, %edx	# p, D.5859
	movl	%eax, 16(%rsp)	# p, %sfp
	imull	%ebx, %edx	# m, D.5859
	movl	%ebx, 76(%rsp)	# m, %sfp
	movslq	%edx, %rdx	# D.5859, D.5860
...
# PRED: 2 [72.0%]  (FALLTHRU,CAN_FALLTHRU)
	movslq	16(%rsp), %rax	# %sfp, D.5860
	movq	%r13, %r15	# Fout, Fout
	movq	%r13, 64(%rsp)	# Fout, %sfp
	movq	%rsi, %r13	# f, f
	movq	48(%rsp), %rbx	# %sfp, fstride
	movq	%r15, %r12	# Fout, Fout
	movq	%rax, %rdi	# D.5860, D.5860
	movq	%rax, 88(%rsp)	# D.5860, %sfp
	movq	%rbx, %rax	# fstride, D.5860
	imulq	%rdi, %rax	# D.5860, D.5860
	movq	%rax, 24(%rsp)	# D.5860, %sfp
	movq	%rbx, %rax	# fstride, fstride
	salq	$2, %rax	#, D.5860
	movq	%rax, %rbx	# D.5860, D.5860
	movq	%rax, 40(%rsp)	# D.5860, %sfp
	movslq	8(%rsp), %rax	# %sfp, D.5860
	imulq	%rbx, %rax	# D.5860, D.5860
	movq	%rax, 32(%rsp)	# D.5860, %sfp
	movslq	76(%rsp), %rax	# %sfp, D.5860
	movq	%rax, 56(%rsp)	# D.5860, %sfp
	leaq	0(,%rax,4), %rbx	#, D.5860
	movq	%rax, 80(%rsp)	# D.5860, %sfp
...
.L11:
	...
	movq	48(%rsp), %rax	# %sfp, D.5860
	imulq	80(%rsp), %rax	# %sfp, D.5860
	leal	(%rbx,%rbx), %edi	#, D.5859
	movslq	%edi, %r8	# D.5859, D.5860
	addl	%ebx, %edi	# m, D.5859
	leaq	0(%r13,%r8,4), %r15	#, Fout2
	movslq	%edi, %rdi	# D.5859, D.5860
	leaq	0(%r13,%rdi,4), %rdi	#, Fout3
	salq	$2, %rax	#, D.5860
	leaq	(%r11,%rax), %rcx	#, D.5863
	movq	%rdi, %r14	# Fout3, Fout3
	leal	0(,%rbx,4), %edi	#, D.5859
	addq	%rcx, %rax	# D.5863, D.5863
...
# PRED: 9 [91.0%]  (FALLTHRU,CAN_FALLTHRU)
	movl	%eax, 64(%rsp)	# D.5859, %sfp
	movq	40(%rsp), %rax	# %sfp, D.5860
	xorl	%r12d, %r12d	# ivtmp.196
	movl	%esi, 32(%rsp)	# D.5859, %sfp
	movswl	%cx, %esi	# yb$r, D.5859
	movl	%esi, 48(%rsp)	# D.5859, %sfp
	movswl	%dx, %esi	# ya$i, D.5859
	movq	%r10, %rdx	# Fout1, Fout1
	movl	%esi, 56(%rsp)	# D.5859, %sfp
	leaq	(%rax,%rax,2), %rax	#, tmp1120
	movq	%r11, 24(%rsp)	# twiddles, %sfp
	movq	%rax, 152(%rsp)	# tmp1120, %sfp
	leal	-1(%rbx), %eax	#, D.5867
	leaq	4(%r15,%rax,4), %rax	#, D.5863
	movq	%r12, 8(%rsp)	# ivtmp.196, %sfp
	movq	%rax, 144(%rsp)	# D.5863, %sfp
...
.L19:
	movswl	0(%r13), %ecx	# MEM[base: Fout_241, offset: 0B], D.5859
	movq	8(%rsp), %r10	# %sfp, ivtmp.196
	imull	$6553, %ecx, %ecx	#, D.5859, D.5859
	addl	$16384, %ecx	#, D.5859
	sarl	$15, %ecx	#, D.5859
	movw	%cx, 0(%r13)	# D.5859, MEM[base: Fout_241, offset: 0B]
	movswl	2(%r13), %ecx	# MEM[base: Fout_241, offset: 2B], D.5859
	imull	$6553, %ecx, %ecx	#, D.5859, D.5859
	addl	$16384, %ecx	#, D.5859
	sarl	$15, %ecx	#, D.5859
	movw	%cx, 2(%r13)	# D.5859, MEM[base: Fout_241, offset: 2B]
	movswl	(%rdx), %ecx	# MEM[base: Fout1_246, offset: 0B], D.5859
	imull	$6553, %ecx, %ecx	#, D.5859, D.5859
	addl	$16384, %ecx	#, D.5859
	sarl	$15, %ecx	#, D.5859
	movw	%cx, (%rdx)	# D.5859, MEM[base: Fout1_246, offset: 0B]
	movswl	2(%rdx), %ecx	# MEM[base: Fout1_246, offset: 2B], D.5859
	imull	$6553, %ecx, %ecx	#, D.5859, D.5859
	addl	$16384, %ecx	#, D.5859
	sarl	$15, %ecx	#, D.5859
	movw	%cx, 2(%rdx)	# D.5859, MEM[base: Fout1_246, offset: 2B]
	movswl	(%rax), %ecx	# MEM[base: Fout2_92, offset: 0B], D.5859
	imull	$6553, %ecx, %ecx	#, D.5859, D.5859
	addl	$16384, %ecx	#, D.5859
	sarl	$15, %ecx	#, D.5859
	movw	%cx, (%rax)	# D.5859, MEM[base: Fout2_92, offset: 0B]
	movswl	2(%rax), %ecx	# MEM[base: Fout2_92, offset: 2B], D.5859
	imull	$6553, %ecx, %ecx	#, D.5859, D.5859
	addl	$16384, %ecx	#, D.5859
	sarl	$15, %ecx	#, D.5859
	movw	%cx, 2(%rax)	# D.5859, MEM[base: Fout2_92, offset: 2B]
	movswl	(%r14), %ecx	# MEM[base: Fout3_98, offset: 0B], D.5859
	imull	$6553, %ecx, %ecx	#, D.5859, D.5859
	addl	$16384, %ecx	#, D.5859
	sarl	$15, %ecx	#, D.5859
	movw	%cx, (%r14)	# D.5859, MEM[base: Fout3_98, offset: 0B]
	movswl	2(%r14), %ecx	# MEM[base: Fout3_98, offset: 2B], D.5859
	imull	$6553, %ecx, %ecx	#, D.5859, D.5859
	addl	$16384, %ecx	#, D.5859
	sarl	$15, %ecx	#, D.5859
	movw	%cx, 2(%r14)	# D.5859, MEM[base: Fout3_98, offset: 2B]
	movswl	(%r15), %esi	# MEM[base: Fout4_561, offset: 0B], D.5859
	movswl	2(%r15), %ecx	# MEM[base: Fout4_561, offset: 2B], D.5859
	imull	$6553, %esi, %esi	#, D.5859, D.5859
	imull	$6553, %ecx, %ecx	#, D.5859, D.5859
	addl	$16384, %esi	#, D.5859
	addl	$16384, %ecx	#, D.5859
	sarl	$15, %esi	#, D.5859
	sarl	$15, %ecx	#, D.5859
	movw	%si, (%r15)	# D.5859, MEM[base: Fout4_561, offset: 0B]
	movw	%cx, 2(%r15)	# D.5859, MEM[base: Fout4_561, offset: 2B]
	movswl	(%rdx), %edi	# MEM[base: Fout1_246, offset: 0B], D.5859
	movzwl	2(%r13), %ebx	# MEM[base: Fout_241, offset: 2B], scratch$0$i
	movl	%edi, 76(%rsp)	# D.5859, %sfp
	movq	136(%rsp), %rdi	# %sfp, twiddles
	movw	%bx, 16(%rsp)	# scratch$0$i, %sfp
	movswl	2(%rdx), %ebx	# MEM[base: Fout1_246, offset: 2B], D.5859
	movswl	(%rdi,%r10), %r11d	# MEM[base: twiddles_46, index: ivtmp.196_320, offset: 0B], D.5859
	movswl	2(%rdi,%r10), %ebp	# MEM[base: twiddles_46, index: ivtmp.196_320, offset: 2B], D.5859
	movl	%r11d, %r12d	# D.5859, D.5859
	movswl	(%rax), %r11d	# MEM[base: Fout2_92, offset: 0B], D.5859
	movl	%r11d, 120(%rsp)	# D.5859, %sfp
	movq	%r10, %r11	# ivtmp.196, ivtmp.196
	movswl	(%rdi,%r10,2), %r10d	# MEM[base: twiddles_46, index: ivtmp.196_320, step: 2, offset: 0B], D.5859
	movl	%r10d, 124(%rsp)	# D.5859, %sfp
	movswl	2(%rax), %r9d	# MEM[base: Fout2_92, offset: 2B], D.5859
	movswl	(%r14), %r8d	# MEM[base: Fout3_98, offset: 0B], D.5859
	movl	%r12d, 116(%rsp)	# D.5859, %sfp
	movl	%r9d, 80(%rsp)	# D.5859, %sfp
	movswl	2(%rdi,%r11,2), %r9d	# MEM[base: twiddles_46, index: ivtmp.196_320, step: 2, offset: 2B], D.5859
	movl	%r8d, 88(%rsp)	# D.5859, %sfp
	movq	24(%rsp), %r11	# %sfp, ivtmp.201
	movswl	2(%r14), %r8d	# MEM[base: Fout3_98, offset: 2B], D.5859
	movswl	(%r11), %r10d	# MEM[base: _1111, offset: 0B], D.5859
	movl	%r8d, 104(%rsp)	# D.5859, %sfp
	movswl	2(%r11), %r8d	# MEM[base: _1111, offset: 2B], D.5859
	movq	8(%rsp), %r11	# %sfp, ivtmp.196
	movl	%r10d, 96(%rsp)	# D.5859, %sfp
	movswl	(%rdi,%r11,4), %r10d	# MEM[base: twiddles_46, index: ivtmp.196_320, step: 4, offset: 0B], D.5859
	movswl	2(%rdi,%r11,4), %r11d	# MEM[base: twiddles_46, index: ivtmp.196_320, step: 4, offset: 2B], D.5859
	movl	76(%rsp), %edi	# %sfp, D.5859
	imull	%r12d, %edi	# D.5859, D.5859
	movl	%ebx, %r12d	# D.5859, D.5859
	imull	%ebp, %r12d	# D.5859, D.5859
	subl	%r12d, %edi	# D.5859, D.5859
	movl	%esi, %r12d	# D.5859, D.5859
	imull	%r10d, %r12d	# D.5859, D.5859
	addl	$16384, %edi	#, D.5859
	sarl	$15, %edi	#, D.5859
	imull	%r11d, %esi	# D.5859, D.5859
	imull	76(%rsp), %ebp	# %sfp, D.5859
	movl	%edi, 112(%rsp)	# D.5859, %sfp
	imull	116(%rsp), %ebx	# %sfp, D.5859
	movl	%r12d, %edi	# D.5859, D.5859
	movl	%ecx, %r12d	# D.5859, D.5859
	imull	%r11d, %r12d	# D.5859, D.5859
	movl	124(%rsp), %r11d	# %sfp, D.5859
	imull	%r10d, %ecx	# D.5859, D.5859
	leal	16384(%rbp,%rbx), %ebx	#, D.5859
	subl	%r12d, %edi	# D.5859, D.5859
	movl	%ebx, %ebp	# D.5859, D.5859
	movl	104(%rsp), %ebx	# %sfp, D.5859
	leal	16384(%rsi,%rcx), %ecx	#, D.5859
	addl	$16384, %edi	#, D.5859
	sarl	$15, %ebp	#, D.5859
	movl	80(%rsp), %esi	# %sfp, D.5859
	sarl	$15, %edi	#, D.5859
	movl	%ebp, 76(%rsp)	# D.5859, %sfp
	movl	120(%rsp), %ebp	# %sfp, D.5859
	sarl	$15, %ecx	#, D.5859
	movl	%edi, %r12d	# D.5859, D.5861
	addw	112(%rsp), %r12w	# %sfp, D.5861
	movl	%edi, 128(%rsp)	# D.5859, %sfp
	movl	%ecx, 132(%rsp)	# D.5859, %sfp
	imull	%r8d, %ebx	# D.5859, D.5859
	imull	%r9d, %esi	# D.5859, D.5859
	imull	%ebp, %r9d	# D.5859, D.5859
	movswl	%r12w, %edi	# D.5861,
	movl	%ecx, %r12d	# D.5859, D.5861
	movl	%ebp, %ecx	# D.5859, D.5859
	addw	76(%rsp), %r12w	# %sfp, D.5861
	imull	%r11d, %ecx	# D.5859, D.5859
	subl	%esi, %ecx	# D.5859, D.5859
	movl	%r12d, %r10d	# D.5861, D.5861
	addl	$16384, %ecx	#, D.5859
	sarl	$15, %ecx	#, D.5859
	movl	%ecx, 116(%rsp)	# D.5859, %sfp
	movl	88(%rsp), %ecx	# %sfp, D.5859
	imull	96(%rsp), %ecx	# %sfp, D.5859
	subl	%ebx, %ecx	# D.5859, D.5859
	addl	$16384, %ecx	#, D.5859
	sarl	$15, %ecx	#, D.5859
	movl	%ecx, 120(%rsp)	# D.5859, %sfp
	movl	%ecx, %r12d	# D.5859, D.5861
	addw	116(%rsp), %r12w	# %sfp, D.5861
	movl	80(%rsp), %ecx	# %sfp, D.5859
	imull	88(%rsp), %r8d	# %sfp, D.5859
	movl	96(%rsp), %esi	# %sfp, D.5859
	imull	104(%rsp), %esi	# %sfp, D.5859
	movl	%r12d, %ebx	# D.5861, D.5861
	movswl	%r12w, %ebp	# D.5861, D.5859
	imull	%r11d, %ecx	# D.5859, D.5859
	movzwl	0(%r13), %r11d	# MEM[base: Fout_241, offset: 0B], D.5861
	movl	32(%rsp), %r12d	# %sfp, D.5859
	leal	16384(%r8,%rsi), %esi	#, D.5859
	leal	16384(%r9,%rcx), %ecx	#, D.5859
	leal	(%rbx,%r11), %r8d	#, D.5861
	sarl	$15, %ecx	#, D.5859
	movl	48(%rsp), %ebx	# %sfp, D.5859
	sarl	$15, %esi	#, D.5859
	addl	%edi, %r8d	# D.5861, tmp1204
	movw	%r8w, 0(%r13)	# tmp1204, MEM[base: Fout_241, offset: 0B]
	movzwl	16(%rsp), %r8d	# %sfp, scratch$0$i
	leal	(%rsi,%rcx), %r9d	#, D.5861
	subl	%esi, %ecx	# D.5859, D.5861
	movswl	%cx, %ecx	# D.5861, D.5859
	addl	%r9d, %r8d	# D.5861, D.5861
	addl	%r10d, %r8d	# D.5861, tmp1206
	movw	%r8w, 2(%r13)	# tmp1206, MEM[base: Fout_241, offset: 2B]
	movl	%edi, %r8d	# D.5859, D.5859
	movl	%ebx, %edi	# D.5859, D.5859
	imull	%ebp, %edi	# D.5859, D.5859
	movl	%r8d, 80(%rsp)	# D.5859, %sfp
	imull	%r12d, %r8d	# D.5859, D.5859
	addl	$16384, %edi	#, D.5859
	sarl	$15, %edi	#, D.5859
	addl	$16384, %r8d	#, D.5859
	addl	%r11d, %edi	# D.5861, D.5861
	sarl	$15, %r8d	#, D.5859
	addl	%r8d, %edi	# D.5859, D.5861
	movw	%di, 88(%rsp)	# D.5861, %sfp
	movswl	%r10w, %edi	# D.5861, D.5859
	movl	%edi, %r10d	# D.5859, D.5859
	movswl	%r9w, %edi	# D.5861, D.5859
	movl	%edi, 104(%rsp)	# D.5859, %sfp
	imull	%ebx, %edi	# D.5859, D.5859
	movl	%r10d, %r9d	# D.5859, D.5859
	movl	56(%rsp), %ebx	# %sfp, D.5859
	imull	%r12d, %r9d	# D.5859, D.5859
	movzwl	76(%rsp), %r12d	# %sfp, D.5861
	movl	%r10d, 96(%rsp)	# D.5859, %sfp
	subw	132(%rsp), %r12w	# %sfp, D.5861
	addl	$16384, %edi	#, D.5859
	sarl	$15, %edi	#, D.5859
	addw	16(%rsp), %di	# %sfp, D.5861
	addl	$16384, %r9d	#, D.5859
	sarl	$15, %r9d	#, D.5859
	movswl	%r12w, %r8d	# D.5861,
	movzwl	112(%rsp), %r12d	# %sfp, D.5861
	subw	128(%rsp), %r12w	# %sfp, D.5861
	movl	%r8d, 76(%rsp)	# D.5859, %sfp
	addl	%edi, %r9d	# D.5861, D.5861
	movl	%r8d, %edi	# D.5859, D.5859
	imull	%ebx, %edi	# D.5859, D.5859
	leal	16384(%rdi), %r10d	#, D.5859
	movl	%r10d, %esi	# D.5859, D.5859
	sarl	$15, %esi	#, D.5859
	movl	%esi, %edi	# D.5859, D.5859
	movl	64(%rsp), %esi	# %sfp, D.5859
	imull	%ecx, %esi	# D.5859, D.5859
	leal	16384(%rsi), %r10d	#, D.5859
	movl	%r10d, %esi	# D.5859, D.5859
	sarl	$15, %esi	#, D.5859
	leal	(%rdi,%rsi), %r10d	#, D.5861
	movswl	%r12w, %esi	# D.5861,
	movl	%ebx, %edi	# D.5859, D.5859
	movzwl	116(%rsp), %r12d	# %sfp, D.5861
	imull	%esi, %edi	# D.5859, D.5859
	subw	120(%rsp), %r12w	# %sfp, D.5861
	addl	$16384, %edi	#, D.5859
	movswl	%r12w, %r8d	# D.5861,
	movl	%edi, %r12d	# D.5859, D.5859
	movl	64(%rsp), %edi	# %sfp, D.5859
	sarl	$15, %r12d	#, D.5859
	imull	%r8d, %edi	# D.5859, D.5859
	addl	$16384, %edi	#, D.5859
	sarl	$15, %edi	#, D.5859
	addl	%r12d, %edi	# D.5859, D.5861
	movzwl	88(%rsp), %r12d	# %sfp, D.5861
	movl	%r12d, %ebx	# D.5861, tmp1237
	subl	%r10d, %ebx	# D.5861, tmp1237
	movw	%bx, (%rdx)	# tmp1237, MEM[base: Fout1_246, offset: 0B]
	leal	(%rdi,%r9), %ebx	#, tmp1238
	subl	%edi, %r9d	# D.5861, tmp1240
	movw	%bx, 2(%rdx)	# tmp1238, MEM[base: Fout1_246, offset: 2B]
	movl	%r12d, %ebx	# D.5861, D.5861
	movl	%ebp, %r12d	# D.5859, D.5859
	movw	%r9w, 2(%r15)	# tmp1240, MEM[base: Fout4_561, offset: 2B]
	movl	32(%rsp), %r9d	# %sfp, D.5859
	addl	%ebx, %r10d	# D.5861, tmp1239
	movw	%r10w, (%r15)	# tmp1239, MEM[base: Fout4_561, offset: 0B]
	movl	80(%rsp), %r10d	# %sfp, D.5859
	movl	48(%rsp), %ebx	# %sfp, D.5859
	movl	104(%rsp), %ebp	# %sfp, D.5859
	imull	%r9d, %r12d	# D.5859, D.5859
	imull	%ebx, %r10d	# D.5859, D.5859
	leal	16384(%r12), %edi	#, D.5859
	imull	%r9d, %ebp	# D.5859, D.5859
	sarl	$15, %edi	#, D.5859
	addl	%edi, %r11d	# D.5859, D.5861
	movl	%r10d, %edi	# D.5859, D.5859
	movl	96(%rsp), %r10d	# %sfp, D.5859
	addl	$16384, %edi	#, D.5859
	movl	%ebp, %r9d	# D.5859, D.5859
	movl	56(%rsp), %ebp	# %sfp, D.5859
	sarl	$15, %edi	#, D.5859
	addl	$16384, %r9d	#, D.5859
	addl	%r11d, %edi	# D.5861, D.5861
	movl	64(%rsp), %r11d	# %sfp, D.5859
	sarl	$15, %r9d	#, D.5859
	imull	%ebx, %r10d	# D.5859, D.5859
	movl	76(%rsp), %ebx	# %sfp, D.5859
	addw	16(%rsp), %r9w	# %sfp, D.5861
	imull	%ebp, %ecx	# D.5859, D.5859
	imull	%ebp, %r8d	# D.5859, D.5859
	addl	$16384, %r10d	#, D.5859
	imull	%r11d, %esi	# D.5859, D.5859
	imull	%r11d, %ebx	# D.5859, D.5859
	sarl	$15, %r10d	#, D.5859
	addl	$16384, %ecx	#, D.5859
	addl	%r10d, %r9d	# D.5859, D.5861
	sarl	$15, %ecx	#, D.5859
	addl	$16384, %r8d	#, D.5859
	addl	$16384, %esi	#, D.5859
	leal	16384(%rbx), %r10d	#, D.5859
	sarl	$15, %esi	#, D.5859
	movq	152(%rsp), %rbx	# %sfp, tmp1120
	sarl	$15, %r10d	#, D.5859
	subl	%r10d, %ecx	# D.5859, D.5861
	sarl	$15, %r8d	#, D.5859
	addq	$4, %r13	#, Fout
	subl	%r8d, %esi	# D.5859, D.5861
	addq	$4, %rdx	#, Fout1
	addq	$4, %rax	#, Fout2
	leal	(%rdi,%rcx), %r8d	#, tmp1267
	subl	%ecx, %edi	# D.5861, tmp1269
	addq	$4, %r14	#, Fout3
	addq	%rbx, 24(%rsp)	# tmp1120, %sfp
	movw	%r8w, -4(%rax)	# tmp1267, MEM[base: Fout2_92, offset: 0B]
	leal	(%r9,%rsi), %r8d	#, tmp1268
	subl	%esi, %r9d	# D.5861, tmp1270
	movw	%r8w, -2(%rax)	# tmp1268, MEM[base: Fout2_92, offset: 2B]
	movq	40(%rsp), %rsi	# %sfp, D.5860
	addq	$4, %r15	#, Fout4
	addq	%rsi, 8(%rsp)	# D.5860, %sfp
...
.L9:
	...
	movq	40(%rsp), %rcx	# %sfp, D.5860
	subl	$1, %eax	#, D.5867
# SUCC: 15 [100.0%]  (FALLTHRU,CAN_FALLTHRU)
	leaq	4(%r13,%rax,4), %rsi	#, D.5863
# BLOCK 15 freq:98 seq:13
# PRED: 14 [100.0%]  (FALLTHRU,CAN_FALLTHRU) 15 [91.0%]  (DFS_BACK,CAN_FALLTHRU)
	.p2align 4,,10
	.p2align 3
.L12:
	movswl	0(%r13), %edx	# MEM[base: Fout_54, offset: 0B], D.5859
	addq	$4, %rbx	#, Fout2
	movl	%edx, %eax	# D.5859, tmp902
	sall	$14, %eax	#, tmp902
	subl	%edx, %eax	# D.5859, D.5859
	movswl	2(%r13), %edx	# MEM[base: Fout_54, offset: 2B], D.5859
	addl	$16384, %eax	#, D.5859
	sarl	$15, %eax	#, D.5859
	movw	%ax, 0(%r13)	# D.5859, MEM[base: Fout_54, offset: 0B]
	movl	%edx, %eax	# D.5859, tmp908
	sall	$14, %eax	#, tmp908
	subl	%edx, %eax	# D.5859, D.5859
	addl	$16384, %eax	#, D.5859
	sarl	$15, %eax	#, D.5859
	movw	%ax, 2(%r13)	# D.5859, MEM[base: Fout_54, offset: 2B]
	movswl	-4(%rbx), %eax	# MEM[base: Fout2_67, offset: 0B], D.5859
	movswl	-2(%rbx), %edx	# MEM[base: Fout2_67, offset: 2B], D.5859
	movl	%eax, %edi	# D.5859, tmp914
	sall	$14, %edi	#, tmp914
	subl	%eax, %edi	# D.5859, D.5859
	movl	%edx, %eax	# D.5859, tmp919
	sall	$14, %eax	#, tmp919
	addl	$16384, %edi	#, D.5859
	subl	%edx, %eax	# D.5859, D.5859
	sarl	$15, %edi	#, D.5859
	addl	$16384, %eax	#, D.5859
	movw	%di, -4(%rbx)	# D.5859, MEM[base: Fout2_67, offset: 0B]
	movl	%edi, %edx	# D.5859, D.5859
	sarl	$15, %eax	#, D.5859
	movw	%ax, -2(%rbx)	# D.5859, MEM[base: Fout2_67, offset: 2B]
	movswl	0(%rbp), %r8d	# MEM[base: tw1_81, offset: 0B], D.5859
	movl	%eax, %r10d	# D.5859, D.5859
	movswl	2(%rbp), %r9d	# MEM[base: tw1_81, offset: 2B], D.5859
	addq	%rcx, %rbp	# D.5860, tw1
	imull	%r8d, %edx	# D.5859, D.5859
	imull	%r9d, %r10d	# D.5859, D.5859
	imull	%r9d, %edi	# D.5859, D.5859
	imull	%r8d, %eax	# D.5859, D.5859
	subl	%r10d, %edx	# D.5859, D.5859
	movzwl	0(%r13), %r10d	# MEM[base: Fout_54, offset: 0B], D.5861
	addl	$16384, %edx	#, D.5859
	leal	16384(%rdi,%rax), %eax	#, D.5859
	sarl	$15, %edx	#, D.5859
	sarl	$15, %eax	#, D.5859
	subl	%edx, %r10d	# D.5859, D.5861
	movw	%r10w, -4(%rbx)	# D.5861, MEM[base: Fout2_67, offset: 0B]
	movzwl	2(%r13), %edi	# MEM[base: Fout_54, offset: 2B], D.5861
	subl	%eax, %edi	# D.5859, D.5861
	movw	%di, -2(%rbx)	# D.5861, MEM[base: Fout2_67, offset: 2B]
	addw	%dx, 0(%r13)	# D.5859, MEM[base: Fout_54, offset: 0B]
	addw	%ax, 2(%r13)	# D.5859, MEM[base: Fout_54, offset: 2B]
	addq	$4, %r13	#, Fout
	cmpq	%rsi, %r13	# D.5863, Fout
...
.L59:
	...
	movslq	%ecx, %rsi	#, D.5860
	movq	%rdi, %rdx	# Fout, Fout
	salq	$2, %rax	#, D.5860
	imulq	%rax, %rsi	# D.5860, D.5860
...
.L20:
	...
	movl	%ebx, %eax	# p, p
	subl	$1, %eax	#, D.5867
	leaq	4(%rdi,%rax,4), %rax	#, D.5868
	movl	%esi, 88(%rsp)	# tmp1629, %sfp
	movq	%rax, 96(%rsp)	# D.5868, %sfp
	movl	76(%rsp), %eax	# %sfp, D.5864
	imull	%esi, %eax	# fstride, D.5864
	movl	%eax, 48(%rsp)	# D.5864, %sfp
	movl	%ebx, %eax	# p, p
	subl	$2, %eax	#, D.5867
	leaq	8(%rdi,%rax,4), %r14	#, D.5868
...
# PRED: 28 [91.0%]  (FALLTHRU,CAN_FALLTHRU)
	...
	movq	24(%rsp), %rsi	# %sfp, ivtmp.103
	cltd
	movq	64(%rsp), %rdi	# %sfp, ivtmp.101
	idivl	%ebx	# p
	movq	32(%rsp), %r8	# %sfp, D.5860
# SUCC: 30 [100.0%]  (FALLTHRU,CAN_FALLTHRU)
	movq	96(%rsp), %r9	# %sfp, D.5868
...
.L22:
	...
	addq	%r8, %rdi	# D.5860, ivtmp.101
	movswl	%dx, %ecx	# MEM[base: _814, offset: 0B], D.5859
	sarl	$16, %edx	#, D.5859
	imull	%eax, %ecx	# tmp1305, D.5859
	imull	%eax, %edx	# tmp1305, D.5859
	addl	$16384, %ecx	#, D.5859
	addl	$16384, %edx	#, D.5859
	sarl	$15, %ecx	#, D.5859
	sarl	$15, %edx	#, D.5859
	movw	%cx, -4(%rsi)	# D.5859, MEM[base: _1194, offset: 0B]
	movw	%dx, -2(%rsi)	# D.5859, MEM[base: _1194, offset: 2B]
	cmpq	%r9, %rsi	# D.5868, ivtmp.103
...
# PRED: 30 [9.0%]  (FALLTHRU,CAN_FALLTHRU,LOOP_EXIT)
	...
	movl	$0, 8(%rsp)	#, %sfp
	movl	80(%rsp), %r13d	# %sfp, ivtmp.92
	movq	64(%rsp), %rbx	# %sfp, ivtmp.90
...
# PRED: 32 [91.0%]  (FALLTHRU,CAN_FALLTHRU)
	movq	24(%rsp), %rax	# %sfp, scratch
	movzwl	(%rbx), %r11d	# MEM[base: _1199, offset: 0B], D.5862
	movzwl	2(%rbx), %r10d	# MEM[base: _1199, offset: 2B], D.5862
...
# PRED: 33 [100.0%]  (FALLTHRU,CAN_FALLTHRU) 34 [91.0%]  (DFS_BACK,CAN_FALLTHRU)
	...
	.p2align 3
.L26:
	addl	%r13d, %eax	# ivtmp.92, D.5864
	movswl	(%r9), %r8d	# MEM[base: _1243, offset: 0B], D.5859
	movl	%eax, %edx	# D.5864, twidx
	movswl	2(%r9), %ecx	# MEM[base: _1243, offset: 2B], D.5859
	subl	%ebp, %edx	# Norig, twidx
	cmpl	%eax, %ebp	# D.5864, Norig
	cmovle	%edx, %eax	# D.5864,, twidx, twidx
	addq	$4, %r9	#, ivtmp.79
	movslq	%eax, %rdx	# twidx, D.5860
	movl	%ecx, %r12d	# D.5859, D.5859
	leaq	(%r15,%rdx,4), %rdx	#, D.5863
	movswl	(%rdx), %edi	# _832->r, D.5859
	movswl	2(%rdx), %esi	# _832->i, D.5859
	movl	%r8d, %edx	# D.5859, D.5859
	imull	%edi, %edx	# D.5859, D.5859
	imull	%esi, %r12d	# D.5859, D.5859
	imull	%edi, %ecx	# D.5859, D.5859
	imull	%r8d, %esi	# D.5859, D.5859
	subl	%r12d, %edx	# D.5859, D.5859
	addl	$16384, %edx	#, D.5859
	sarl	$15, %edx	#, D.5859
	addl	%edx, %r11d	# D.5859, D.5862
	leal	16384(%rsi,%rcx), %edx	#, D.5859
	movw	%r11w, (%rbx)	# D.5862, MEM[base: _1199, offset: 0B]
	sarl	$15, %edx	#, D.5859
	addl	%edx, %r10d	# D.5859, D.5862
	movw	%r10w, 2(%rbx)	# D.5862, MEM[base: _1199, offset: 2B]
	cmpq	%r9, %r14	# ivtmp.79, D.5868
...
.L25:
	addl	$1, 56(%rsp)	#, %sfp
	movl	88(%rsp), %edi	# %sfp, D.5864
	movl	56(%rsp), %eax	# %sfp, k
	addq	$4, 64(%rsp)	#, %sfp
	addl	%edi, 80(%rsp)	# D.5864, %sfp
...
.L10:
	...
	leaq	0(%r13,%rbx), %r11	#, ivtmp.167
	movq	%rax, %rdi	# tw3, tw3
	movq	48(%rsp), %rax	# %sfp, fstride
	movq	%rdi, 8(%rsp)	# tw3, %sfp
	movq	%rdi, %rbx	# tw3, tw3
	movq	%rdi, %r15	# tw3, tw3
	leaq	0(,%rax,8), %rsi	#, D.5860
	leaq	(%rax,%rax,2), %rax	#, tmp1016
	movq	%rsi, 88(%rsp)	# D.5860, %sfp
	salq	$2, %rax	#, tmp1017
	movq	%rax, 104(%rsp)	# tmp1017, %sfp
	movl	4(%rbp), %eax	# st_32(D)->inverse, D.5859
	movl	%eax, 96(%rsp)	# D.5859, %sfp
	movq	80(%rsp), %rax	# %sfp, k
	leaq	0(%r13,%rax,8), %rbp	#, ivtmp.169
	leaq	0(%rbp,%rax,4), %r8	#, ivtmp.171
# SUCC: 43 [100.0%]  (CAN_FALLTHRU)
	jmp	.L18	#
# BLOCK 41 freq:49 seq:39
# PRED: 43 [50.0%]  (CAN_FALLTHRU)
.L62:
	movzwl	64(%rsp), %r10d	# %sfp, D.5861
	movzwl	76(%rsp), %ecx	# %sfp, D.5861
	movl	%r10d, %eax	# D.5861, tmp1098
	subl	%esi, %eax	# D.5861, tmp1098
	movw	%ax, (%r11)	# tmp1098, MEM[base: _1157, offset: 0B]
	movl	%ecx, %eax	# D.5861, D.5861
	addl	%edi, %eax	# D.5861, tmp1099
	movw	%ax, 2(%r11)	# tmp1099, MEM[base: _1157, offset: 2B]
	movl	%r10d, %eax	# D.5861, D.5861
	addl	%eax, %esi	# D.5861, tmp1100
	movl	%ecx, %eax	# D.5861, tmp1101
	subl	%edi, %eax	# D.5861, tmp1101
...
.L17:
	addq	$4, %r13	#, Fout
	addq	$4, %r11	#, ivtmp.167
	addq	$4, %rbp	#, ivtmp.169
	addq	$4, %r8	#, ivtmp.171
	subq	$1, 80(%rsp)	#, %sfp
...
.L18:
	movswl	0(%r13), %edx	# MEM[base: Fout_278, offset: 0B], D.5859
	movl	%edx, %eax	# D.5859, tmp1022
	sall	$13, %eax	#, tmp1022
	subl	%edx, %eax	# D.5859, D.5859
	movswl	2(%r13), %edx	# MEM[base: Fout_278, offset: 2B], D.5859
	addl	$16384, %eax	#, D.5859
	sarl	$15, %eax	#, D.5859
	movw	%ax, 0(%r13)	# D.5859, MEM[base: Fout_278, offset: 0B]
	movl	%edx, %eax	# D.5859, tmp1028
	sall	$13, %eax	#, tmp1028
	subl	%edx, %eax	# D.5859, D.5859
	addl	$16384, %eax	#, D.5859
	sarl	$15, %eax	#, D.5859
	movw	%ax, 2(%r13)	# D.5859, MEM[base: Fout_278, offset: 2B]
	movswl	(%r11), %edx	# MEM[base: _1157, offset: 0B], D.5859
	movl	%edx, %eax	# D.5859, tmp1034
	sall	$13, %eax	#, tmp1034
	subl	%edx, %eax	# D.5859, D.5859
	movswl	2(%r11), %edx	# MEM[base: _1157, offset: 2B], D.5859
	addl	$16384, %eax	#, D.5859
	sarl	$15, %eax	#, D.5859
	movw	%ax, (%r11)	# D.5859, MEM[base: _1157, offset: 0B]
	movl	%edx, %eax	# D.5859, tmp1040
	sall	$13, %eax	#, tmp1040
	subl	%edx, %eax	# D.5859, D.5859
	addl	$16384, %eax	#, D.5859
	sarl	$15, %eax	#, D.5859
	movw	%ax, 2(%r11)	# D.5859, MEM[base: _1157, offset: 2B]
	movswl	0(%rbp), %edx	# MEM[base: _1142, offset: 0B], D.5859
	movl	%edx, %eax	# D.5859, tmp1046
	sall	$13, %eax	#, tmp1046
	subl	%edx, %eax	# D.5859, D.5859
	movswl	2(%rbp), %edx	# MEM[base: _1142, offset: 2B], D.5859
	addl	$16384, %eax	#, D.5859
	sarl	$15, %eax	#, D.5859
	movw	%ax, 0(%rbp)	# D.5859, MEM[base: _1142, offset: 0B]
	movl	%edx, %eax	# D.5859, tmp1052
	sall	$13, %eax	#, tmp1052
	subl	%edx, %eax	# D.5859, D.5859
	addl	$16384, %eax	#, D.5859
	sarl	$15, %eax	#, D.5859
	movw	%ax, 2(%rbp)	# D.5859, MEM[base: _1142, offset: 2B]
	movswl	(%r8), %eax	# MEM[base: _1137, offset: 0B], D.5859
	movswl	2(%r8), %ecx	# MEM[base: _1137, offset: 2B], D.5859
	movl	%eax, %edx	# D.5859, tmp1058
	sall	$13, %edx	#, tmp1058
	subl	%eax, %edx	# D.5859, D.5859
	movl	%ecx, %eax	# D.5859, tmp1063
	sall	$13, %eax	#, tmp1063
	addl	$16384, %edx	#, D.5859
	subl	%ecx, %eax	# D.5859, D.5859
	sarl	$15, %edx	#, D.5859
	movq	8(%rsp), %rcx	# %sfp, tw3
	addl	$16384, %eax	#, D.5859
	movw	%dx, (%r8)	# D.5859, MEM[base: _1137, offset: 0B]
	sarl	$15, %eax	#, D.5859
	movw	%ax, 2(%r8)	# D.5859, MEM[base: _1137, offset: 2B]
	movswl	(%r11), %edi	# MEM[base: _1157, offset: 0B], D.5859
	movswl	(%rcx), %r10d	# MEM[base: tw3_376, offset: 0B], D.5859
	movswl	0(%rbp), %r14d	# MEM[base: _1142, offset: 0B], D.5859
	movswl	(%rbx), %r12d	# MEM[base: tw3_356, offset: 0B], D.5859
	movl	%edi, 56(%rsp)	# D.5859, %sfp
	movswl	(%r15), %edi	# MEM[base: tw3_335, offset: 0B], D.5859
	movl	%r10d, 32(%rsp)	# D.5859, %sfp
	movswl	2(%rcx), %r10d	# MEM[base: tw3_376, offset: 2B], D.5859
	movswl	2(%rbx), %r9d	# MEM[base: tw3_356, offset: 2B], D.5859
	movl	%r14d, %ecx	# D.5859, D.5859
	movswl	2(%r11), %esi	# MEM[base: _1157, offset: 2B], D.5859
	imull	%r12d, %ecx	# D.5859, D.5859
	movl	%edi, 16(%rsp)	# D.5859, %sfp
	movswl	2(%rbp), %edi	# MEM[base: _1142, offset: 2B], D.5859
	movl	%r10d, 48(%rsp)	# D.5859, %sfp
	movl	%esi, 24(%rsp)	# D.5859, %sfp
	movswl	2(%r15), %esi	# MEM[base: tw3_335, offset: 2B], D.5859
	movl	%edi, %r10d	# D.5859, D.5859
	imull	%r12d, %edi	# D.5859, D.5859
	imull	%r9d, %r10d	# D.5859, D.5859
	imull	%r14d, %r9d	# D.5859, D.5859
	subl	%r10d, %ecx	# D.5859, D.5859
	movzwl	0(%r13), %r10d	# MEM[base: Fout_278, offset: 0B], D.5861
	leal	16384(%r9,%rdi), %r14d	#, D.5859
	addl	$16384, %ecx	#, D.5859
	movl	16(%rsp), %r9d	# %sfp, D.5859
	sarl	$15, %ecx	#, D.5859
	movzwl	2(%r13), %edi	# MEM[base: Fout_278, offset: 2B], D.5861
	sarl	$15, %r14d	#, D.5859
	movl	%ecx, %r12d	# D.5859, D.5861
	addw	0(%r13), %r12w	# MEM[base: Fout_278, offset: 0B], D.5861
	subl	%ecx, %r10d	# D.5859, D.5861
	movw	%r10w, 64(%rsp)	# D.5861, %sfp
	movl	56(%rsp), %r10d	# %sfp, D.5859
	subl	%r14d, %edi	# D.5859, D.5861
	addw	2(%r13), %r14w	# MEM[base: Fout_278, offset: 2B], D.5861
	movw	%di, 76(%rsp)	# D.5861, %sfp
	movl	24(%rsp), %edi	# %sfp, D.5859
	movw	%r12w, 0(%r13)	# D.5861, MEM[base: Fout_278, offset: 0B]
	imull	%r10d, %r9d	# D.5859, D.5859
	movw	%r14w, 2(%r13)	# D.5861, MEM[base: Fout_278, offset: 2B]
	imull	%esi, %edi	# D.5859, D.5859
	movl	%r9d, %ecx	# D.5859, D.5859
	movl	32(%rsp), %r9d	# %sfp, D.5859
	imull	%r10d, %esi	# D.5859, D.5859
	movl	16(%rsp), %r10d	# %sfp, D.5859
	imull	24(%rsp), %r10d	# %sfp, D.5859
	subl	%edi, %ecx	# D.5859, D.5859
	addl	$16384, %ecx	#, D.5859
	imull	%edx, %r9d	# D.5859, D.5859
	sarl	$15, %ecx	#, D.5859
	imull	48(%rsp), %edx	# %sfp, D.5859
	leal	16384(%rsi,%r10), %esi	#, D.5859
	movl	%ecx, %r10d	# D.5859, D.5861
	sarl	$15, %esi	#, D.5859
	movl	%r9d, %edi	# D.5859, D.5859
	movl	48(%rsp), %r9d	# %sfp, D.5859
	imull	%eax, %r9d	# D.5859, D.5859
	imull	32(%rsp), %eax	# %sfp, D.5859
	subl	%r9d, %edi	# D.5859, D.5859
	leal	16384(%rdx,%rax), %eax	#, D.5859
	addl	$16384, %edi	#, D.5859
	sarl	$15, %edi	#, D.5859
	sarl	$15, %eax	#, D.5859
	leal	(%rdi,%rcx), %r9d	#, D.5861
	movl	96(%rsp), %ecx	# %sfp,
	subl	%edi, %r10d	# D.5859, D.5861
	leal	(%rax,%rsi), %edx	#, D.5861
	subl	%r9d, %r12d	# D.5861, tmp1096
	subl	%eax, %esi	# D.5859, D.5861
	subl	%edx, %r14d	# D.5861, tmp1097
	movw	%r12w, 0(%rbp)	# tmp1096, MEM[base: _1142, offset: 0B]
	addq	40(%rsp), %r15	# %sfp, tw3
	movl	%r10d, %edi	# D.5861, D.5861
	movw	%r14w, 2(%rbp)	# tmp1097, MEM[base: _1142, offset: 2B]
	addq	88(%rsp), %rbx	# %sfp, tw3
	movq	104(%rsp), %r14	# %sfp, tmp1017
	addw	%r9w, 0(%r13)	# D.5861, MEM[base: Fout_278, offset: 0B]
	addq	%r14, 8(%rsp)	# tmp1017, %sfp
	addw	%dx, 2(%r13)	# D.5861, MEM[base: Fout_278, offset: 2B]
	testl	%ecx, %ecx	#
# SUCC: 41 [50.0%]  (CAN_FALLTHRU) 44 [50.0%]  (FALLTHRU,CAN_FALLTHRU)
	jne	.L62	#,
# BLOCK 44 freq:49 seq:42
# PRED: 43 [50.0%]  (FALLTHRU,CAN_FALLTHRU)
	movzwl	64(%rsp), %edx	# %sfp, D.5861
	movzwl	76(%rsp), %ecx	# %sfp, D.5861
	movl	%edx, %eax	# D.5861, D.5861
	addl	%esi, %eax	# D.5861, tmp1102
	movw	%ax, (%r11)	# tmp1102, MEM[base: _1157, offset: 0B]
	movl	%ecx, %eax	# D.5861, tmp1103
	addl	%edi, %ecx	# D.5861, tmp1105
	subl	%edi, %eax	# D.5861, tmp1103
	movw	%ax, 2(%r11)	# tmp1103, MEM[base: _1157, offset: 2B]
	movl	%edx, %eax	# D.5861, tmp1104
	subl	%esi, %eax	# D.5861, tmp1104
...
.L31:
	movq	56(%rsp), %rax	# %sfp, D.5860
	movq	%rax, 16(%rsp)	# D.5860, %sfp
# SUCC: 46 [100.0%]  (FALLTHRU,CAN_FALLTHRU)
	movq	%rax, %rsi	# D.5860, m
...
.L7:
	...
	addq	%r13, %rbx	# Fout, ivtmp.143
	leaq	0(%r13,%rsi,8), %r9	#, ivtmp.145
	movq	%r12, %r15	# tw2, tw2
	movq	%rdi, %rax	# fstride, D.5860
	imulq	%rsi, %rax	# m, D.5860
	movswl	266(%rbp,%rax,4), %eax	# MEM[(struct  *)_124 + 2B], D.5859
	movl	%eax, 24(%rsp)	# D.5859, %sfp
	movq	%rdi, %rax	# fstride, D.5860
	salq	$3, %rax	#, D.5860
...
# PRED: 46 [100.0%]  (FALLTHRU,CAN_FALLTHRU) 47 [91.0%]  (DFS_BACK,CAN_FALLTHRU)
	...
	.p2align 3
.L14:
	movswl	0(%r13), %eax	# MEM[base: Fout_127, offset: 0B], D.5859
	imull	$10922, %eax, %eax	#, D.5859, D.5859
	addl	$16384, %eax	#, D.5859
	sarl	$15, %eax	#, D.5859
	movw	%ax, 0(%r13)	# D.5859, MEM[base: Fout_127, offset: 0B]
	movswl	2(%r13), %eax	# MEM[base: Fout_127, offset: 2B], D.5859
	imull	$10922, %eax, %eax	#, D.5859, D.5859
	addl	$16384, %eax	#, D.5859
	sarl	$15, %eax	#, D.5859
	movw	%ax, 2(%r13)	# D.5859, MEM[base: Fout_127, offset: 2B]
	movswl	(%rbx), %eax	# MEM[base: _1187, offset: 0B], D.5859
	imull	$10922, %eax, %eax	#, D.5859, D.5859
	addl	$16384, %eax	#, D.5859
	sarl	$15, %eax	#, D.5859
	movw	%ax, (%rbx)	# D.5859, MEM[base: _1187, offset: 0B]
	movswl	2(%rbx), %eax	# MEM[base: _1187, offset: 2B], D.5859
	imull	$10922, %eax, %eax	#, D.5859, D.5859
	addl	$16384, %eax	#, D.5859
	sarl	$15, %eax	#, D.5859
	movw	%ax, 2(%rbx)	# D.5859, MEM[base: _1187, offset: 2B]
	movswl	(%r9), %edx	# MEM[base: _1183, offset: 0B], D.5859
	movswl	2(%r9), %eax	# MEM[base: _1183, offset: 2B], D.5859
	imull	$10922, %edx, %edx	#, D.5859, D.5859
	imull	$10922, %eax, %eax	#, D.5859, D.5859
	addl	$16384, %edx	#, D.5859
	addl	$16384, %eax	#, D.5859
	sarl	$15, %edx	#, D.5859
	sarl	$15, %eax	#, D.5859
	movw	%dx, (%r9)	# D.5859, MEM[base: _1183, offset: 0B]
	movw	%ax, 2(%r9)	# D.5859, MEM[base: _1183, offset: 2B]
	movswl	(%rbx), %ebp	# MEM[base: _1187, offset: 0B], D.5859
	movswl	2(%rbx), %r8d	# MEM[base: _1187, offset: 2B], D.5859
	movswl	(%r12), %r11d	# MEM[base: tw2_170, offset: 0B], D.5859
	movswl	2(%r12), %r10d	# MEM[base: tw2_170, offset: 2B], D.5859
	movl	%ebp, %ecx	# D.5859, D.5859
	movswl	(%r15), %esi	# MEM[base: tw2_190, offset: 0B], D.5859
	movl	%r8d, %r14d	# D.5859, D.5859
	movswl	2(%r15), %edi	# MEM[base: tw2_190, offset: 2B], D.5859
	imull	%r11d, %ecx	# D.5859, D.5859
	imull	%r10d, %r14d	# D.5859, D.5859
	imull	%r11d, %r8d	# D.5859, D.5859
	imull	%ebp, %r10d	# D.5859, D.5859
	subl	%r14d, %ecx	# D.5859, D.5859
	movl	%eax, %r14d	# D.5859, D.5859
	addl	$16384, %ecx	#, D.5859
	imull	%edi, %r14d	# D.5859, D.5859
	leal	16384(%r10,%r8), %r8d	#, D.5859
	sarl	$15, %ecx	#, D.5859
	movl	%ecx, 8(%rsp)	# D.5859, %sfp
	movl	%edx, %ecx	# D.5859, D.5859
	sarl	$15, %r8d	#, D.5859
	imull	%esi, %ecx	# D.5859, D.5859
	subl	%r14d, %ecx	# D.5859, D.5859
	movzwl	8(%rsp), %r14d	# %sfp, tmp1426
	addl	$16384, %ecx	#, D.5859
	sarl	$15, %ecx	#, D.5859
	addl	%ecx, %r14d	# D.5859, D.5861
	imull	%edi, %edx	# D.5859, D.5859
	movzwl	0(%r13), %edi	# MEM[base: Fout_127, offset: 0B], D.5861
	addq	$4, %r9	#, ivtmp.145
	imull	%esi, %eax	# D.5859, D.5859
	addq	40(%rsp), %r12	# %sfp, tw2
	addq	32(%rsp), %r15	# %sfp, tw2
	leal	16384(%rdx,%rax), %eax	#, D.5859
	movl	%r14d, %edx	# D.5861, D.5862
	sarw	%dx	# D.5862
	sarl	$15, %eax	#, D.5859
	leal	(%rax,%r8), %esi	#, D.5861
	subl	%edx, %edi	# D.5862, D.5861
	subl	%eax, %r8d	# D.5859, D.5861
	movw	%di, (%rbx)	# D.5861, MEM[base: _1187, offset: 0B]
	movzwl	2(%r13), %edi	# MEM[base: Fout_127, offset: 2B], D.5861
	movl	%esi, %edx	# D.5861, D.5862
	sarw	%dx	# D.5862
	subl	%edx, %edi	# D.5862, D.5861
	movswl	%r8w, %edx	# D.5861, D.5859
	movw	%di, 2(%rbx)	# D.5861, MEM[base: _1187, offset: 2B]
	movl	24(%rsp), %edi	# %sfp, D.5859
	addw	%r14w, 0(%r13)	# D.5861, MEM[base: Fout_127, offset: 0B]
	addw	%si, 2(%r13)	# D.5861, MEM[base: Fout_127, offset: 2B]
	addq	$4, %r13	#, Fout
	imull	%edi, %edx	# D.5859, D.5859
	addl	$16384, %edx	#, D.5859
	sarl	$15, %edx	#, D.5859
	movl	%edx, %eax	# D.5859, D.5861
	addw	(%rbx), %ax	# MEM[base: _1187, offset: 0B], D.5861
	movw	%ax, -4(%r9)	# D.5861, MEM[base: _1183, offset: 0B]
	movzwl	8(%rsp), %eax	# %sfp, D.5861
	subl	%ecx, %eax	# D.5859, D.5861
	movzwl	2(%rbx), %ecx	# MEM[base: _1187, offset: 2B], D.5861
	cwtl
	imull	%edi, %eax	# D.5859, D.5859
	addl	$16384, %eax	#, D.5859
	sarl	$15, %eax	#, D.5859
	subl	%eax, %ecx	# D.5859, D.5861
	movw	%cx, -2(%r9)	# D.5861, MEM[base: _1183, offset: 2B]
	subw	%dx, (%rbx)	# D.5859, MEM[base: _1187, offset: 0B]
	addw	%ax, 2(%rbx)	# D.5859, MEM[base: _1187, offset: 2B]
	addq	$4, %rbx	#, ivtmp.143
	subq	$1, 16(%rsp)	#, %sfp
...
# PRED: 7 [91.0%]  (FALLTHRU,CAN_FALLTHRU)
	pxor	%xmm3, %xmm3	# D.5922
	cvtsi2sd	%ebx, %xmm3	# nfft, D.5922
	xorl	%r15d, %r15d	# i
	movsd	.LC6(%rip), %xmm0	#, tmp271
	movsd	.LC8(%rip), %xmm4	#, tmp329
	leaq	264(%r14), %rbp	#, D.5928
	leaq	40(%rsp), %r13	#, tmp324
	movsd	%xmm4, (%rsp)	# tmp329, %sfp
	leaq	32(%rsp), %r12	#, tmp323
	movsd	.LC9(%rip), %xmm4	#, tmp330
	divsd	%xmm3, %xmm0	# D.5922, D.5922
	movsd	%xmm3, 24(%rsp)	# D.5922, %sfp
	movsd	%xmm4, 8(%rsp)	# tmp330, %sfp
	mulsd	.LC7(%rip), %xmm0	#, D.5922
	movsd	%xmm0, 16(%rsp)	# D.5922, %sfp
...
# PRED: 8 [50.0%]  (FALLTHRU,CAN_FALLTHRU) 9 [91.0%]  (DFS_BACK,CAN_FALLTHRU)
	...
	.p2align 3
.L105:
	pxor	%xmm0, %xmm0	# D.5922
	cvtsi2sd	%r15d, %xmm0	# i, D.5922
	movq	%r12, %rsi	# tmp323,
	mulsd	16(%rsp), %xmm0	# %sfp, phase
	movq	%r13, %rdi	# tmp324,
	call	sincos	#
	movsd	32(%rsp), %xmm1	#, D.5922
	pxor	%xmm2, %xmm2	# tmp284
	movsd	(%rsp), %xmm3	# %sfp, tmp329
	movsd	8(%rsp), %xmm5	# %sfp, tmp330
	mulsd	%xmm3, %xmm1	# tmp329, D.5922
	movsd	40(%rsp), %xmm0	#, D.5927
	mulsd	%xmm3, %xmm0	# tmp329, D.5922
	addsd	%xmm5, %xmm1	# tmp330, D.5922
	addsd	%xmm5, %xmm0	# tmp330, D.5922
	cvttsd2si	%xmm1, %eax	# D.5922, tmp283
	cvtsi2sd	%eax, %xmm2	# tmp283, tmp284
	leal	-1(%rax), %edx	#, tmp339
	comisd	%xmm1, %xmm2	# D.5922, tmp284
	pxor	%xmm1, %xmm1	# tmp292
	cmova	%edx, %eax	# tmp283,, tmp339, tmp283
	movw	%ax, 0(%rbp)	# tmp283, MEM[base: _83, offset: 0B]
	cvttsd2si	%xmm0, %eax	# D.5922, tmp291
	cvtsi2sd	%eax, %xmm1	# tmp291, tmp292
	leal	-1(%rax), %edx	#, tmp341
	comisd	%xmm0, %xmm1	# D.5922, tmp292
	cmova	%edx, %eax	# tmp291,, tmp341, tmp291
	addl	$1, %r15d	#, i
	addq	$4, %rbp	#, ivtmp.228
...
.L106:
	...
	sqrtsd	24(%rsp), %xmm0	# %sfp, D.5922
	movsd	.LC3(%rip), %xmm2	#, tmp176
	leaq	8(%r14), %rcx	#, facbuf
	andpd	%xmm0, %xmm1	# D.5922, tmp178
...
.L69:
	...
	movl	$4, %esi	#, nfft
	comisd	%xmm0, %xmm1	# D.5922, tmp182
...
# PRED: 11 [50.0%]  (FALLTHRU,CAN_FALLTHRU)
	comisd	%xmm0, %xmm1	# D.5922, tmp183
...
.L109:
	...
	mulsd	%xmm4, %xmm1	# tmp329, D.5922
	movsd	40(%rsp), %xmm0	#, D.5927
	mulsd	%xmm4, %xmm0	# tmp329, D.5922
	addsd	%xmm6, %xmm1	# tmp330, D.5922
	addsd	%xmm6, %xmm0	# tmp330, D.5922
	cvttsd2si	%xmm1, %eax	# D.5922, tmp306
	cvtsi2sd	%eax, %xmm2	# tmp306, tmp307
	leal	-1(%rax), %edx	#, tmp340
	comisd	%xmm1, %xmm2	# D.5922, tmp307
	pxor	%xmm1, %xmm1	# tmp315
	cmova	%edx, %eax	# tmp306,, tmp340, tmp306
	movw	%ax, 0(%rbp)	# tmp306, MEM[base: _153, offset: 0B]
	cvttsd2si	%xmm0, %eax	# D.5922, tmp314
	cvtsi2sd	%eax, %xmm1	# tmp314, tmp315
	leal	-1(%rax), %edx	#, tmp342
	comisd	%xmm0, %xmm1	# D.5922, tmp315
	cmova	%edx, %eax	# tmp314,, tmp342, tmp314
	addl	$1, %r15d	#, i
	addq	$4, %rbp	#, ivtmp.234
...
.L147:
	.cfi_restore_state
	comisd	%xmm0, %xmm1	# D.5922, D.5922
...
.L87:
	addl	$2, %esi	#, D.5923
	pxor	%xmm2, %xmm2	# D.5922
	movq	%rcx, %rax	# facbuf, facbuf
	cvtsi2sd	%esi, %xmm2	# D.5923, D.5922
	comisd	%xmm0, %xmm2	# D.5922, D.5922
...
# PRED: 50 [50.0%]  (FALLTHRU,CAN_FALLTHRU)
	addl	$2, %esi	#, nfft
	pxor	%xmm1, %xmm1	# D.5922
	movl	%ebx, %eax	# nfft, tmp320
	cvtsi2sd	%esi, %xmm1	# nfft, D.5922
	comisd	%xmm0, %xmm1	# D.5922, D.5922
	cmova	%ebx, %esi	# nfft,, nfft, nfft
	cltd
	idivl	%esi	# nfft
...
# PRED: 10 [50.0%]  (CAN_FALLTHRU)
	...
	.p2align 3
.L159:
	cvttsd2siq	%xmm0, %rax	# D.5922, tmp181
	pxor	%xmm0, %xmm0	# D.5922
	cvtsi2sdq	%rax, %xmm0	# tmp181, D.5922
...
# SUCC: 63 [100.0%]  (FALLTHRU,CAN_FALLTHRU)
	cvtsi2sd	%esi, %xmm1	# D.5923, D.5922
...
# PRED: 35 [50.0%]  (CAN_FALLTHRU)
	...
	.p2align 3
.L124:
	movapd	%xmm1, %xmm2	# D.5922, D.5922
	movl	$3, %esi	#, nfft
# SUCC: 43 [100.0%]  (CAN_FALLTHRU)
	jmp	.L100	#
...
# PRED: 7 [9.0%]  (CAN_FALLTHRU)
	...
	.p2align 3
.L158:
	pxor	%xmm7, %xmm7	# D.5922
	cvtsi2sd	%ebx, %xmm7	# nfft, D.5922
	movsd	%xmm7, 24(%rsp)	# D.5922, %sfp
...
.L168:
	...
	subq	$8, %rsp	#,
	.cfi_def_cfa_offset 48
	movslq	(%rdi), %rdi	# st_4(D)->nfft, D.5955
	salq	$2, %rdi	#, D.5955
	call	malloc	#
	movq	%rbx, %r9	# st,
	...
	movq	%rax, %r13	#, tmp103
	call	kf_work	#
	movslq	(%rbx), %rdx	# st_4(D)->nfft, D.5955
	movq	%rbp, %rdi	# fin,
	movq	%r13, %rsi	# tmp103,
	salq	$2, %rdx	#, D.5955
	call	memcpy	#
...
.L172:
	...
	movslq	(%rdi), %rdi	# cfg_2(D)->nfft, D.5975
	salq	$2, %rdi	#, D.5975
	call	malloc	#
	movq	%rbx, %r9	# cfg,
	movq	%rbp, %rsi	# fin,
	...
	movq	%rax, %r12	#, tmp102
	call	kf_work	#
	movslq	(%rbx), %rdx	# cfg_2(D)->nfft, D.5975
	movq	%rbp, %rdi	# fin,
	movq	%r12, %rsi	# tmp102,
	salq	$2, %rdx	#, D.5975
	call	memcpy	#
